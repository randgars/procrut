        ...
        <ToolbarGroup>
          ...
          }
          {
            ...
            <ul className="header__contact header__contact_custom">
              <li>+375 (29) 55-622-00<PhoneIco className="header__phone-ico"/></li>
              <hr className="divider divider__list-item"/>
              <li>procrut@yahoo.com<EmailIco className="header__phone-ico"/></li>
              <hr className="divider divider__list-item"/>
              <li><a className="vk-group-item" href="https://vk.com/ClubProCrut">Наша группа ВК</a> <img src="../../images/vk.svg" alt=""/></li>
            </ul>
          }
          {
            this.state.desktop &&
