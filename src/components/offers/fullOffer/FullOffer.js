  ...
  render() {
    return (
      <Paper className={`offer-container shown-block-${this.state.displayBlock} `} zDepth={2}>
        <Subheader className="offer-container__title">Полное</Subheader>
        <Divider/>
        <div className="offer-container__list-wrapper">
          <List>
            <ListItem disabled={true} className="offer-container__item offer-container__item-price" primaryText="85р. за комплекс" />
            <ListItem disabled={true} className="offer-container__item" primaryText="БЕСПЛАТНАЯ доставка велосипеда в мастерскую" />
            <Divider/>
            ...
            <Divider/>
            <ListItem disabled={true} className="offer-container__item" primaryText="Переборка рулевой" />
            <Divider/>
            ...
            <Divider/>
            <ListItem disabled={true} className="offer-container__item" primaryText="Устранение восьмерок (до 2 мм)" />
            <Divider/>
...
FullOffer.displayName = 'FullOffer';
FullOffer.propTypes = {};
